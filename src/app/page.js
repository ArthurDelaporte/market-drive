  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        <main className="py-12 px-4 md:mt-12 mt-40" role="main" aria-labelledby="main-heading">
          <h1 id="main-heading" className="sr-only">Accueil</h1>
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" aria-labelledby="features-heading">
            <h2 id="features-heading" className="sr-only">Fonctionnalités</h2>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <h3 className="text-xl font-semibold text-[#424242] mb-4">Choisissez vos produits</h3>
          ...
          <section className="mt-12 text-center" aria-labelledby="cta-heading">
            <h2 id="cta-heading" className="text-3xl font-bold text-[#F57C00]">Prêt à faire vos courses ?</h2>
